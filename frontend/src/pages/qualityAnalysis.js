/**
 * StegX Quality Analysis Page — Rewritten from Scratch
 */
      ...
      r.innerHTML = `
        ...
        ${
          data.histogram_original
            ? `<div class="glass-panel stagger-item"><h3 class="section-title">📊 Histogram Comparison</h3><div style="height:300px;"><canvas id="qa-histogram"></canvas></div></div>`
            : ''
        }`;
