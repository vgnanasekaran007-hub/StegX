/**
 * StegX Settings Page — Rewritten from Scratch
 */
...
export function renderSettings(container) {
  container.innerHTML = `
    <div class="page-header">
      ...
      <p class="page-subtitle">Configure application preferences, performance, and visual effects</p>
    </div>
    ...
    <div class="glass-panel stagger-item" style="margin-bottom:24px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
        <div class="input-group">
          ...
          <select class="input-field setting-input" data-key="theme">
        ...
        <div class="input-group">
          ...
          <select class="input-field setting-input" data-key="animation_speed">
    ...
    <div class="glass-panel stagger-item" style="margin-bottom:24px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
        <div class="input-group">
          <label class="input-label">GPU Acceleration</label>
          <select class="input-field setting-input" data-key="gpu_acceleration">
        ...
        <div class="input-group">
          ...
          <select class="input-field setting-input" data-key="performance">
    ...
    <div class="glass-panel stagger-item" style="margin-bottom:24px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
        <div class="input-group">
          ...
          <select class="input-field setting-input" data-key="language">
    ...
    <div class="glass-panel mt-32 stagger-item">
      ...
      <div class="text-sm text-muted">
        ...
        <p>Mail: <a href="mailto:v.gnanasekaran007@gmail.com" style="color:var(--accent); text-decoration:none;">v.gnanasekaran007@gmail.com</a>
           | GitHub: <a href="https://github.com/vgnanasekaran007-hub" target="_blank" style="color:var(--accent); text-decoration:none;">github.com/vgnanasekaran007-hub</a></p>
  ...
  // ── Save ─────────────────────────────────────────────────────
  _on('save-settings-btn', 'click', async () => {
    const inputs = document.querySelectorAll('.setting-input');
    for (const input of inputs) {
      try {
        await apiFetch(
          `/api/settings?key=${encodeURIComponent(input.dataset.key)}&value=${encodeURIComponent(input.value)}`,
          { method: 'POST' }
        );
